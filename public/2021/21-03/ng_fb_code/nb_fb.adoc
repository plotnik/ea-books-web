...
See <<Section 6: Using Angularfire & Firebase>>
...
icon:book[2x] &nbsp;
link:https://ea-books.netlify.app/2019/19-05/ng_pwa_code/ng_pwa.html[`19-05/ng_pwa`]
*PWA with Angular*

icon:arrow-circle-o-right[2x] &nbsp;
*AngularFire:*
https://github.com/angular/angularfire

icon:arrow-circle-o-right[2x] &nbsp;
*All AngularFire Docs:*
